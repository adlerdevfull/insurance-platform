  ...
  <div class="min-h-screen bg-gradient-to-br from-blue-900 to-blue-700 flex items-center justify-center">
    <div class="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
      <div class="text-center mb-8">
        ...
        <h1 class="text-2xl font-bold text-gray-900">InsurePlatform</h1>
        <p class="text-gray-400 text-sm mt-1">Gestión de Seguros y Sinistros</p>
      </div>
      ...
      <p class="text-center text-xs text-gray-400 mt-6">admin@insurance.test / password</p>
    </div>
  </div>
</template>
